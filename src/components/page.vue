      ...
      >
        <div class="p-4 md:p-12 text-center lg:text-left">
          ...
          <p class="pt-8 text-md">
            Hey, my name is Luka and business is my passion! I also love to
            code, market and all sorts of other stuff! Most importantly, I like
            making my ideas and dreams a reality!
          </p>

          <div class="pt-12 pb-8">
            <a class="focus:outline-none" href="mailto:mail@lukabudik.cz"
              ><button
                class="bg-blue-700 hover:bg-blue-900 text-white font-bold py-2 px-4 rounded-full duration-500 focus:outline-none"
              >
                Contact me
              </button>
            </a>
